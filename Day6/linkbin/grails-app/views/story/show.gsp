	...
	<body>
		...
		<div id="show-story" class="content scaffold-show" role="main">
			...
			<ol class="property-list story">
				...
				<g:if test="${storyInstance?.link}">
				<li class="fieldcontain">
					<span id="link-label" class="property-label"><g:message code="story.link.label" default="Link" /></span>
					
						<span class="property-value" aria-labelledby="link-label"><g:fieldValue bean="${storyInstance}" field="link"/></span>
				...
				<g:if test="${storyInstance?.submittedOn}">
				<li class="fieldcontain">
					<span id="submittedOn-label" class="property-label"><g:message code="story.submittedOn.label" default="Submitted On" /></span>
					
						<span class="property-value" aria-labelledby="submittedOn-label"><g:fieldValue bean="${storyInstance}" field="submittedOn"/></span>
